...
<head>
    ...
    <title>Archived Questions</title>
</head>

<body class="bg-gray-200 p-4">

    <div class="w-full pr-4 mb-4">
        <?php
        $sql = "SELECT * FROM question WHERE archived = 1";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo '<div class="max-w-xl bg-white p-8 rounded-md shadow-md my-5 cursor-pointer hover:shadow-xl">
                        <div class="flex items-center text-gray-600 mb-4">
                            ...
                            <div class="ml-2">
                                <p class="text-sm">Posted by ' . $row['user_id'] . '</p>
                                <p class="text-xs">Posted on ' . $row['created_at'] . '</p>
                            </div>
                        </div>
                        <div class="mb-6">
                            <p class="text-gray-700">' . $row['question_text'] . '</p>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button class="flex items-center text-gray-600 hover:text-red-500">
                                ...
                                <span class="ml-1">' . $row['dislikes'] . '</span>
                            </button>
            ...
            echo "No archived questions found.";
        }
        ?>
    </div>
