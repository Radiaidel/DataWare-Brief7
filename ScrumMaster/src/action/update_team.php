    ...
    <div class="bg-white p-8 rounded w-96 shadow-md max-w-md rounded-2xl">
        ...
        <form method="post" class="space-y-4">
            ...
            <button type="submit" name="update_team"
                class="w-full text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">Update
                Team</button>
