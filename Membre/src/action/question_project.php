        ...
        <div class="w-full space-y-4">
            ...
            <div class="bg-white p-4 rounded-lg shadow-md mt-4 ">
                ...
                foreach ($projectQuestions as $question) {
                    ?>
                    <div
                        class="w-full bg-white p-8 rounded-md shadow-md my-5 cursor-pointer hover:shadow-xl border border-4 border-black">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button class="flex items-center text-gray-600 hover:text-green-500">
                                <svg width="20px" height="20px" viewBox="0 0 32 32" version="1.1"
                                    ...
                                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:
                                        type="MSPage">
