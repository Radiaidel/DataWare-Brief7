...
if (isset($_GET['filter'])) {
            ...
            <div class="max-w-xl bg-white p-8 rounded-md shadow-md my-5 cursor-pointer hover:shadow-xl">
                ...
                <div class="flex items-center text-gray-600 mb-4">
                    <div class="flex-shrink-0">
                        <svg width="30px" height="30px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:
                            xlink="http://www.w3.org/1999/xlink" fill="#17d924" stroke="#17d924">
                        </svg>
                    </div>
                    <div class="ml-2">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button class="flex items-center text-gray-600 hover:text-blue-500">
                        <svg fill="#0473c8" width="20px" height="20px" viewBox="0 0 24 24" id="a11298b2-e15e-46f5-bfd2-69e168954b14"
                            data-name="Livello 1" xmlns="http://www.w3.org/2000/svg" stroke="#0473c8">
                    ...
                    <button class="flex items-center text-gray-600 hover:text-red-500">
                        <svg fill="#0473c8" height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button class="flex items-center text-gray-600 hover:text-green-500">
                        <svg width="20px" height="20px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:
                            xlink="http://www.w3.org/1999/xlink" xmlns: sketch="http://www.bohemiancoding.com/sketch/ns">
    ...
    echo "Filter parameter not provided.";
}
?>